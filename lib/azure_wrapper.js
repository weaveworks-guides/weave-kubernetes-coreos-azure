...
var coreos_image_ids = {
  'stable': '2b171e93f07c4903bcad35bda10acf22__CoreOS-Stable-899.13.0',
  'beta': '2b171e93f07c4903bcad35bda10acf22__CoreOS-Beta-991.2.0', // untested
  'alpha': '2b171e93f07c4903bcad35bda10acf22__CoreOS-Alpha-1000.0.0' // untested
};
...
exports.run_task_queue = function (dummy) {
  ...
  var pop_task = function() {
    ...
    var ret = {};
    var cur = tasks.todo.shift();
    if (cur !== undefined && cur instanceof Array) {
      ret.current = cur.filter(function(x) { return (x !== undefined) ; });
    } else {
      ret.current = cur;
    }
